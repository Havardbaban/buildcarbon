        ...
        <section className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-4 text-slate-600 text-lg">
              Envesto finds cost savings, grants, and carbon reductions—then produces a bank-ready report (NPV, IRR, DSCR, Payback).
            </p>
            <div className="mt-6 flex flex-wrap gap-3">
              <Link to="/demo" className="rounded-xl px-5 py-3 text-white" style={{ background: "#0E9F6E" }}>
                Try the Demo
              </Link>
              <Link to="/report" className="rounded-xl px-5 py-3 border">
                View Report Builder
              </Link>
            ...
            <ul className="mt-8 grid gap-2 text-sm text-slate-700">
              ...
              <li>• Bank/insurer/tax-ready PDF</li>
            </ul>
          </div>
