      ...
      <main className="mx-auto max-w-6xl px-4 py-12">
        ...
        <section className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <a
                href="mailto:hello@envesto.app?subject=Envesto%20Pilot%20Inquiry"
          ...
          <div className="border rounded-2xl p-6 bg-white">
            ...
            <div className="rounded-xl border p-4">
              <div className="font-semibold">Case A: Office Efficiency Upgrade</div>
        ...
        <section className="mt-12 grid gap-2 text-sm text-slate-700">
          <ul className="list-disc ml-6 space-y-1">
            ...
            <li>Grants & incentives (coming in MVP v1)</li>
